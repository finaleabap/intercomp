*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZINTCOMP_MV_007
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZINTCOMP_MV_007     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZINTCOMP_MV_007'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZINTCOMP_MV_007_EXTRACT
TOTAL = ZINTCOMP_MV_007_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZINTCOMP_MV_007'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZINTCOMP_MV_007-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZINTCOMP_MV_007_EXTRACT
TOTAL = ZINTCOMP_MV_007_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZINTCOMP_MV_007-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZINTCOMP_MV_007'
...
TOTAL = ZINTCOMP_MV_007_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZINTCOMP_MV_007-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZINTCOMP_MV_007-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZINTCOMP_MV_007'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZINTCOMP_MV_007-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZINTCOMP_MV_007_EXTRACT
TOTAL = ZINTCOMP_MV_007_TOTAL
